...
function Socials() {
  return (
    <div>
      <div className="hidden lg:flex flex-row items-center justify-center space-x-4 px-4">
        <div className="text-blackish  border-2  border-blackish green-400 w-10 h-10 rounded-full flex items-center justify-center p-1 hover:text-gray-700">
        ...
        <div className="text-blackish green-400 border-2  border-blackish green-400 w-10 h-10 rounded-full flex items-center justify-center p-1 hover:text-gray-700">
        ...
        <div className="text-blackish green-400 border-2  border-blackish green-400 w-10 h-10 rounded-full flex items-center justify-center p-1 hover:text-gray-700">
          <a href={socialdata[3].link} rel="noreferrer" target="_blank">
            <svg
              width="24"
              height="24"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-blackish green-400 border-2  border-blackish green-400 w-10 h-10 rounded-full flex items-center justify-center p-1 hover:text-gray-700">
          <a href={socialdata[4].link} rel="noreferrer" target="_blank">
            <svg
              width="24"
              height="24"
              xmlns="http://www.w3.org/2000/svg"
